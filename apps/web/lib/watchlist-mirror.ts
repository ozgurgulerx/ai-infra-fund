...
export const watchlist: WatchlistEntry[] = [
  ...
  },
  {
    ...
    themes: ["ai_accelerators", "compute_supply_chain", "mobile_compute"],
    sectorTags: ["semiconductors", "cpu_architecture", "ai_infrastructure"],
    priority: "high",
    sourceUrls: ["https://investors.arm.com/"],
  },
  {
    ticker: "SMCI",
    companyName: "Super Micro Computer",
    themes: ["datacenter_servers", "ai_data_centers", "hyperscaler_capex"],
    sectorTags: ["hardware", "servers", "ai_infrastructure"],
    priority: "high",
    sourceUrls: ["https://ir.supermicro.com/"],
  },
  {
    ticker: "DELL",
    ...
    sectorTags: ["hardware", "servers", "ai_infrastructure"],
    priority: "high",
    sourceUrls: ["https://investors.delltechnologies.com/"],
  },
  {
    ticker: "HPE",
    ...
    sectorTags: ["hardware", "servers", "ai_infrastructure"],
    priority: "medium",
    sourceUrls: ["https://investors.hpe.com/"],
  },
  {
    ticker: "MRVL",
    companyName: "Marvell Technology",
    themes: ["ai_networking", "custom_silicon", "data_center_fabrics"],
    sectorTags: ["semiconductors", "networking", "ai_infrastructure"],
    priority: "high",
    sourceUrls: ["https://investor.marvell.com/"],
  },
  {
    ticker: "NEE",
    companyName: "NextEra Energy",
    themes: ["data_center_power", "renewable_power", "hyperscaler_ppa"],
    sectorTags: ["utilities", "power_generation", "ai_infrastructure"],
    priority: "medium",
    sourceUrls: ["https://www.investor.nexteraenergy.com/"],
  },
  {
    ticker: "SO",
    companyName: "Southern Company",
    themes: ["data_center_power", "nuclear_power", "hyperscaler_ppa"],
    sectorTags: ["utilities", "power_generation", "ai_infrastructure"],
    priority: "medium",
    sourceUrls: ["https://investor.southerncompany.com/"],
  },
  {
    ticker: "DUK",
    ...
    sectorTags: ["utilities", "power_generation", "ai_infrastructure"],
    priority: "medium",
    sourceUrls: ["https://investors.duke-energy.com/"],
  },
  {
    ticker: "ORCL",
    companyName: "Oracle",
    ...
    sectorTags: ["cloud_platforms", "software", "ai_infrastructure"],
    priority: "high",
